...
module.exports = {
  get: BaseController.get(ZoomController, 'get'),
  add: BaseController.get(ZoomController, 'add'),
  update: BaseController.get(ZoomController, 'update'),
  delete: BaseController.get(ZoomController, 'delete'),
  getById: BaseController.get(ZoomController, 'getById'),
  getAdmin: BaseController.get(ZoomController, 'getAdmin')
};